package jud.cloud.common.data.datascope;
...
import jud.cloud.common.core.exception.CheckedException;
import jud.cloud.common.data.enums.DataScopeTypeEnum;
...
public class DataScopeInterceptor extends AbstractSqlParserHandler implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (CollUtil.isEmpty(deptIds)) {
            JudCloudUser user = SecurityUtils.getUser();
            if (user == null) {
